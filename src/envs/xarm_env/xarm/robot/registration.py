...
def register_robot_envs(
    ...
    register(
        id="RobotPegbox-v0",
        entry_point="xarm.robot.peg_in_box:PegBoxEnv",
        kwargs=dict(
    ...
    register(
        ...
        entry_point="xarm.robot.hammer_all:HammerAllEnv",
        kwargs=dict(
    ...
    register(
        id="RobotReach-v0",
        entry_point="xarm.robot.reach:ReachEnv",
        kwargs=dict(
    ...
    register(
        id="RobotPush-v0",
        entry_point="xarm.robot.push:PushEnv",
        kwargs=dict(
