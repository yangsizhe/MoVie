...
from algorithm.transform import TransformNet_STN_PerImage, TransformNet_STN1, TransformNet_STN2
...
class TOLD(nn.Module):
    ...
    def adaptation_init(self, cfg):
        ...
        self._encoder = nn.Sequential(
            ...
            list(self._encoder.children())[11],
            list(self._encoder.children())[12],
            list(self._encoder.children())[13],
            list(self._encoder.children())[14]
            )        
...
class TDMPC:
    ...
    def adapt_via_ssl(self, obs, state, next_obs, next_state, action, ssl_task):
        z = self.model.h(obs, state)
        z_next = self.model.h(next_obs, next_state)
