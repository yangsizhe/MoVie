...
# def enc(cfg, transforms):
# 	"""Returns a TOLD encoder."""
# 	if cfg.modality == 'pixels':
# 		C = int(3*cfg.frame_stack)
# 		layers = [NormalizeImg(),
# 	    		  transforms[0],
# 				  nn.Conv2d(C, cfg.num_channels, 7, stride=2), transforms[1], nn.ReLU(),
# 				  nn.Conv2d(cfg.num_channels, cfg.num_channels, 5, stride=2), transforms[2], nn.ReLU(),
# 				  nn.Conv2d(cfg.num_channels, cfg.num_channels, 3, stride=2), transforms[3], nn.ReLU(),
# 				  nn.Conv2d(cfg.num_channels, cfg.num_channels, 3, stride=2), transforms[4], nn.ReLU()]
