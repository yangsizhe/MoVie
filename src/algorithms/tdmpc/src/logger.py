...
def cfg_to_group(cfg, return_list=False):
	...
	lst = ['tdmpc', cfg.task, cfg.modality, re.sub('[^0-9a-zA-Z]+', '-', cfg.exp_name)]
...
class Logger(object):
	...
	def __init__(self, log_dir, cfg):
		...
		if run_offline:
			...
			try:
				...
				import wandb
				wandb.login(key='3368d43be59d5fc2e19fbec31c4675df533628e0')
	...
	def save_model(self, agent, identifier):
		if self._save_model:
			fp = self._model_dir / f'model_{identifier}.pt'
